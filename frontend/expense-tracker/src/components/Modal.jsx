      ...
      <div className="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div className="relative bg-white rounded-lg shadow-md dark:bg-gray-700">
          ...
          <div className="flex items-center justify-between p-4 md:p-5 border-b border-gray-200 dark:border-gray-600">
            ...
            <button
              type="button"
              className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 flex justify-center items-center dark:hover:bg-gray-600 dark:text-white cursor-pointer"
              onClick={onClose}
            >
              <svg
                className="w-3 h-3"
